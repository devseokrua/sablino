...
export const metadata: Metadata = {
  ...
  description:
    'Правила заїзду, проживання, додаткові послуги та умови відпочинку в садибі «Саблінська». Адреса: Кіровоградська область, Суботцівська ОТГ, с. Шаблине, вул. Набережна, 25. Телефон: +38 (096) 756-60-91.',
};
